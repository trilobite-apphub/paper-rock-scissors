...
static void test_01_simpleAssertTrue(void)
{
    ...
    tril_utest_assert_its_true(trueValue);
    tril_utest_assert_its_false(falseValue);
} // end of test case
...
static void test_02_simpleAssertNull(void)
{
    ...
    //
    // here we run the asserts
    tril_utest_assert_its_nullptr(nullPtr);
} // end of test case
...
static void test_03_simpleAssertCompare(void)
{
    ...
    //
    // here we run the asserts
    tril_utest_assert_equal_int(3, dummy);
} // end of test case
...
static void test_04_simpleAssertCall(void)
{
    ...
    //
    // here we run the asserts
    tril_utest_assert_equal_str(dummy, salutations());
} // end of test case
